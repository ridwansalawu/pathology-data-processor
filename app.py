...
from tkinter import Tk, Toplevel, Label, Button, Text, END, filedialog, messagebox, simpledialog
...
def main():
    try:
        ...
        Label(root, text="Welcome to Pathology Data Processor", font=("Helvetica", 16, "bold")).pack(pady=20)
        Label(root, text="This tool processes pathology Excel files and generates a clean report.\n\nClick below to start.", font=("Helvetica", 12), justify="center").pack(pady=20)
        # --- Signature / Proprietary mark ---
        Label(
            root,
            text="© 2026 Ridwan Salawu | All rights reserved.",
        ...
        def start_processing():
            root.withdraw()  # hide intro window
        ...
        # --- Start button ---
        Button(root, text="Start Processing", font=("Helvetica", 12, "bold"), width=20, command=start_processing).pack(pady=40)
